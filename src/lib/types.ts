export type Color = 'none' | 'primary' | 'secondary' | 'primary-dark' | 'danger' | 'warning' | 'info';
...
export type CalendarPlan = { startDate: string, endDate?: string, startTime?: string, endTime?: string, allDay?: boolean, title: string, description?: string, };
